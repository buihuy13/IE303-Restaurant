        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <div className="flex justify-center mb-6">
            <div className="relative">
              <div className="absolute inset-0 bg-orange-200 rounded-full blur-xl opacity-50" />
              <div className="relative bg-linear-to-br from-orange-400 to-orange-600 p-6 rounded-full">
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-6 mb-8">
            <div className="flex items-start gap-4">
              <Rocket className="w-6 h-6 text-orange-600 shrink-0 mt-1" />
              <div className="text-left">
                ...
                <p className="text-sm text-gray-700">
                  ...
                  on creating an amazing experience for you.
                </p>
              </div>
            </div>
          </div>
