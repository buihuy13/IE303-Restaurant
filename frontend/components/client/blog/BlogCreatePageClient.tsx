                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select
                                id="category"
                                value={form.category}
                                onChange={(e) => form.setCategory(e.target.value as import("@/types/blog.type").BlogCategory)}
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#EE4D2D]"
                                aria-label="Category"
                            >
                        ...
                        <div>
                            ...
                            <select
                                id="status"
                                value={form.status}
                                onChange={(e) => form.setStatus(e.target.value as import("@/types/blog.type").BlogStatus)}
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#EE4D2D]"
