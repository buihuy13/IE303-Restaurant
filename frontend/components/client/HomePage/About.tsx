...
const HomePageAbout = () => {
        return (
                <section className="mt-10 relative bg-brand-yellowlight p-5 lg:p-0 lg:pb-[80px]">
                        <div className="custom-container">
                                {/* Top about */}
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8 text-center md:text-left md:justify-items-center items-center py-10 px-5 bg-brand-black text-brand-white overflow-hidden relative -top-10 lg:-top-[60px] rounded-2xl shadow-xl ring-1 ring-white/10">
                                        <Image
                                                src={pizza}
                                                alt="pizza Image"
                                                width={100}
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[130px] items-center">
                                        ...
                                        <ScrollReveal variants={slideInFromRight} delay={0.2}>
                                                <div className="text-center lg:text-left">
                                                        ...
                                                        <p className="mt-4 text-gray-700/90 leading-relaxed">
                                                        ...
                                                        <Button asChild variant="brand" className="mt-7 h-11 rounded-full px-6 shadow-sm hover:shadow-md">
