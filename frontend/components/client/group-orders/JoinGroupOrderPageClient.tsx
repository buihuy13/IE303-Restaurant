                                    ...
                                    <>
                                        ...
                                        <div className="border-t border-gray-200 pt-4">
                                            <div className="flex items-center justify-between mb-4">
                                                ...
                                                <span className="text-xl font-bold text-[#EE4D2D]">${state.totalAmount.toFixed(2)}</span>
                                            </div>
                                            <button
                                                onClick={state.handleSubmit}
                                                disabled={state.isSubmitting || !state.canJoin || state.selectedItems.size === 0}
                                            ...
                                            >
                                                {state.isSubmitting ? "Processing..." : state.isJoined ? "Update items" : "Confirm join"}
                                            </button>
                                        </div>
                                    </>
                                )}
