    ...
    <section className="bg-brand-yellowlight pt-6 md:pb-[100px]">
      <div className="custom-container text-center">
        ...
        <p className="mt-4 max-w-xl mx-auto text-brand-grey">
          We are a team of food lovers who are passionate about connecting
          people with the best local restaurants and providing a seamless and
          enjoyable ordering experience.
        </p>
