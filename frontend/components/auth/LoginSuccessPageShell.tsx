...
import { useLoginSuccessPage } from "@/hooks/auth/useLoginSuccessPage";

export default function LoginSuccessPageShell() {
  const { title, description, primaryLink } = useLoginSuccessPage();
