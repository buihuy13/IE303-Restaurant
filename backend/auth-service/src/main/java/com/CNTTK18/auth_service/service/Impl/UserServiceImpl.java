package com.CNTTK18.auth_service.service.Impl;
...
import com.CNTTK18.auth_service.service.CookiesService;
import com.CNTTK18.auth_service.service.JwtService;
...
public class UserServiceImpl {
    ...
    public void register(Register user) {
        ...
        if (user.getRole().equals(Role.USER)) {
            sendConfirmationEmail(newUser.getUsername(), newUser.getVerificationCode());
        }
    ...
    public void sendVerificationEmail(String email) {
        ...
        sendConfirmationEmail(email, user.getVerificationCode());
    }
    ...
    private void sendConfirmationEmail(String email, UUID verificationCode) {
